...
<head>
    ...
    <title>Desa Cibodas | SURAT NIKAH</title>
...
<body>
    ...
    <div class="section-title" mt-4>
        <h2>SYARAT PEMBUATAN SURAT NIKAH</h2>
    </div>
    <div class="container">
        <h6>Syarat-syarat yang harus dipenuhi dalam Permohonan Pembuatan Surat Izin Menikah ialah :</h6>
        <ul>
            <li>Fotocopy Kartu Tanda Penduduk (calon suami dan istri) .</li>
            <li>Fotocopy Kartu Keluarga (calon suami dan istri).</li>
            <li>Fotocopy Akta Lahir (calon suami dan istri) .</li>
            <li>Fotocopy Ijazah Terakhir (calon suami dan istri)</li>
            <li>Pas Foto 2×3 sebanyak 4 lembar (calon suami dan istri) .</li>
            <li>Pas Foto 4×6 sebanyak 2 lembar (calon suami dan istri) .</li>
            <li>Surat pernyataan belum pernah menikah, yang di tandatangani oleh Calon Pengantin dan Pengurus RT/RW, formulir ini bisa di dapat dari Kelurahan atau RT/TW setempat.</li>
            <li>Surat pernyataan persetujuan orang tua / wali yang di tandatangani oleh Orang Tua, Saksi dan Pengurus RT/RW, formulir(N1-N4) ini juga bisa di dapat dari Kelurahan atau RT/RW setempat</li>
        </ul>
    </div>
    <br>

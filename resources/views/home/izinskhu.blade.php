...
<body>
    ...
    <div class="section-title" mt-4>
        <h2>SYARAT PEMBUATAN SURAT KETERANGAN USAHA</h2>
    </div>
    <div class="container">
        <h6>Syarat-syarat yang harus dipenuhi dalam Permohonan Pembuatan Surat Izin Menikah ialah :</h6>
        <ul>
            <li>SURAT PENGANTAR RT/RW</li>
            <li>FOTOCOPY KTP-el</li>
            <li>FOTOCOPY KK</li>
            <li>ALAMAT USAHA (WILAYAH DESA CIBODAS)</li>
            <li>FOTOCOPY TANDA LUNAS PBB (TAHUN 2023)</li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        ...
                        <ul>
                            ...
                            <li><i class="bx bx-chevron-right"></i> <a href="/izinskhu">Pembuatan SKU</a></li>
                        </ul>
                    </div>

...
<head>
  ...
  <title>Desa Cibodas | Sejarah Desa</title>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <div class="member-img">
            <img src="image/galeri3.jpg" alt="" class="img-fluid">
          </div>
          <br>
          <p>Desa Cibodas merupakan desa yang terletak di pinggiran bagian utara kota majalengka. meskipun Desa Cibodas terletak dipinggiran kota, namun Desa Cibodas memiliki akses jalan
            yang baik yang dapat ditempuh oleh kendaraan bermotor maupun mobil. Hanya memerlukan waktu kurang lebih 10 menit dari Desa Cibodas menuju pusat kota. </p>
        </div>

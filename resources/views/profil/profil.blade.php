...
<head>
  ...
  <title>Desa Cibodas - Profil</title>
...
<body>
  ...
  <section>
    <div class="section-title">
      <h2>MENU PROFILE DESA</h2>
    </div>
    <div class="container" mt-4>
      <ul>
        <li><a href="/visimisi">Visi - Misi Desa Cibodas</li>
        <li><a href="/sotk">Struktur Organisasi dan Tata Kerja Desa Cibodas</li>
      </ul>
    </div>
  </section><!-- End Hero -->
